  ...
  ({ className, hover = false, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'rounded-2xl border border-white/10 bg-neutral-800/50 backdrop-blur shadow-lg',
          hover && 'transition-all hover:shadow-2xl hover:-translate-y-1 hover:bg-neutral-800/70',
          className
        )}
        {...props}
      />
